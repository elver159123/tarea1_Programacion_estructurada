...
def mayor_menor():
    ...
    ventana.configure(bg="#37023a")  # Fondo rosa brillante
    ...
    tk.Label(ventana, text="Ingrese un número:", bg="#37023a", fg="#e7c500", font=("Arial", 12)).pack(pady=5)
    ...
    resultado_label = tk.Label(ventana, text="", bg="#37023a", fg="#e830ce", font=("Arial", 10))
...
def positivo_negativo():
    ...
    ventana.configure(bg="#37023a")  # Fondo rosa magenta
    ventana.geometry("400x200")
    frame = tk.Frame(ventana)
    frame.pack(expand=True, fill="both", padx=10, pady=10)

    tk.Label(ventana, text="Ingrese un número:", bg="#37023a", fg="#2ef8a0", font=("Arial", 12)).pack(pady=5)
    entry_num = tk.Entry(ventana)
    entry_num.pack(pady=5)
    tk.Button(ventana, text="Verificar", bg="#e7c500", fg="black", command=verificar).pack(pady=5)
    resultado_label = tk.Label(ventana, text="", bg="#37023a", fg="#c501e2", font=("Arial", 10))
    resultado_label.pack(pady=5)
...
tk.Button(frame, text=" Mayor o menor", width=30, bg="#e7c500", fg="black", command=mayor_menor).pack(pady=5)
tk.Button(frame, text=" Número positivo o negativo", width=30, bg="#2ef8a0", fg="black", command=positivo_negativo).pack(pady=5)
tk.Button(frame, text=" Par o impar", width=30, bg="#f82d97", fg="white", command=par_impar).pack(pady=5)
tk.Button(frame, text=" Aprobado o reprobado", width=30, bg="#e830ce", fg="white", command=aprobado_reprobado).pack(pady=5)
